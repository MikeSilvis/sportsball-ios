...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _scrollView.panRecognizeInsets = UIEdgeInsetsMake(0, self.bounds.size.width / 2, 0, self.bounds.size.width / 2);
...
-(void)setPanRecognizeInsets:(UIEdgeInsets)panRecognizeInsets {
  _panRecognizeInsets = panRecognizeInsets;
  _scrollView.panRecognizeInsets = panRecognizeInsets;
}
